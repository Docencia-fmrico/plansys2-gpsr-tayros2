...
public:
  ...
  : rclcpp::Node("gpsr_controller_node"), state_(STARTING)
  {
  }
      ...
      case STARTING:
        {
          ...
          problem_expert_->setGoal(plansys2::Goal("(and (move_object clothes bedroom)(move_object tools garage)(move_object towel bathroom)(move_object silverware kitchen)(human_attended granny))"));
